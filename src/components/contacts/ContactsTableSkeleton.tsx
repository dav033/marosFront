      ...
      >
        ...
        {Array.from({ length: rows }).map((_, index) => (
          <div 
            ...
            style={{ 
              borderBottomColor: 'var(--color-gray-subtle)',
              backgroundColor: index % 2 === 0 ? 'var(--color-gray-alt)' : 'var(--color-dark)'
            }}
          >
            <div className="grid grid-cols-7 gap-4 items-center">
              ...
              <div 
                ...
                style={{ 
                  backgroundColor: 'var(--color-gray)',
                  width: index % 3 === 0 ? '85%' : index % 3 === 1 ? '70%' : '95%'
                }}
              ></div>
              ...
              <div 
                ...
                style={{ 
                  backgroundColor: 'var(--color-gray)',
                  width: index % 4 === 0 ? '80%' : index % 4 === 1 ? '90%' : index % 4 === 2 ? '75%' : '85%'
                }}
              ></div>
              ...
              <div 
                ...
                style={{ 
                  backgroundColor: 'var(--color-gray)',
                  width: index % 4 === 0 ? '0%' : index % 4 === 1 ? '65%' : index % 4 === 2 ? '0%' : '75%'
                }}
              ></div>
              ...
              <div 
                ...
                style={{ 
                  backgroundColor: 'var(--color-gray)',
                  width: index % 5 === 0 ? '0%' : index % 5 === 1 ? '90%' : index % 5 === 2 ? '85%' : index % 5 === 3 ? '0%' : '95%'
                }}
              ></div>
              ...
              <div 
                ...
                style={{ 
                  backgroundColor: 'var(--color-gray)',
                  width: index % 6 === 0 ? '80%' : index % 6 === 1 ? '0%' : index % 6 === 2 ? '90%' : index % 6 === 3 ? '0%' : index % 6 === 4 ? '75%' : '85%'
                }}
              ></div>
            </div>
          </div>
