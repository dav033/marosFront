...
export const useCreateLead = ({ leadType, onLeadCreated }: UseCreateLeadOptions) => {
  const createWithNewContact = useCallback(async (formData: LeadFormData) => {
  ...
  const createWithExistingContact = useCallback(async (formData: LeadFormData) => {
