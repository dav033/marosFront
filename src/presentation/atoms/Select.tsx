    ...
    >
      ...
      {filteredOptions.map((opt) => (
        <button
          ...
          className="w-full text-left px-3 py-2 text-sm truncate text-theme-light hover:bg-theme-gray cursor-pointer border-none bg-transparent disabled:opacity-50 disabled:cursor-not-allowed"
          onClick={() => {
